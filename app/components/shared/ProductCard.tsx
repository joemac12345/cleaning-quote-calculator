...
export default function ProductCard({
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-6 relative">
      ...
      <div className="grid gap-6 mb-6" style={{ gridTemplateColumns: '150px 1fr' }}>
        {/* Left - Image */}
        {image && (
          <div>
            <div className="bg-gray-100 rounded overflow-hidden w-5/6 h-40">
        ...
        {features.length > 0 && (
          <div>
            <h4 className="text-sm font-extrabold text-gray-900 mb-3">What's Included:</h4>
