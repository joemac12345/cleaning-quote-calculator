      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3">
        {options.map((option) => {
          ...
          return (
            <label
              key={option.value}
              className={`flex flex-col items-center gap-3 p-6 border rounded-lg cursor-pointer transition relative ${
                isSelected
            ...
            >
              ...
              <input
                ...
                className="absolute top-3 left-3 w-5 h-5 text-[#48546A] accent-[#48546A]"
              />
