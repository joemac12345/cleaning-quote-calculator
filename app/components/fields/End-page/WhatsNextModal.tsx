  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-[9999] flex items-center justify-center p-3 sm:p-4">
      <div className="bg-white rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="sticky top-0 bg-white px-6 sm:px-8 py-5 sm:py-6 border-b border-gray-200 flex justify-between items-center">
          <h2 className="text-lg sm:text-2xl font-bold" style={{ color: '#48546A' }}>
            What Happens Next?
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 sm:p-8 space-y-6">
          <div>
            <h3 className="text-lg font-semibold mb-3" style={{ color: '#48546A' }}>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-medium" style={{ color: '#4B5368' }}>We'll contact you</p>
              ...
              <div className="flex gap-4">
                <div className="flex-shrink-0 text-2xl">📅</div>
                <div>
                  <p className="font-medium" style={{ color: '#4B5368' }}>Schedule your clean</p>
              ...
              <div className="flex gap-4">
                <div className="flex-shrink-0 text-2xl">✨</div>
                <div>
                  <p className="font-medium" style={{ color: '#4B5368' }}>Professional service</p>
              ...
              <div className="flex gap-4">
                <div className="flex-shrink-0 text-2xl">💬</div>
                <div>
                  <p className="font-medium" style={{ color: '#4B5368' }}>Your feedback</p>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            <p className="text-sm text-gray-600">
              <span className="font-medium" style={{ color: '#48546A' }}>Have questions?</span> Feel free to contact us anytime. We're here to help!
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 p-6 sm:p-8">
          <button
            onClick={onClose}
            className="w-full px-6 py-3 text-white font-medium rounded-lg transition"
